...
class gauge_rpm extends View {
	...
	// scale configuration
	private static final int totalNicks = 40;
	...
	private static final int maxDegrees = 60;
	...
	public gauge_rpm(Context context) {
		super(context);
		init();
	}

	public gauge_rpm(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public gauge_rpm(Context context, AttributeSet attrs, int defStyle) {
