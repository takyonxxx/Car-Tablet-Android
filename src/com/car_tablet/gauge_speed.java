...
class gauge_speed extends View {
	...
	// scale configuration
	private static final int totalNicks = 110;
	private static final float degreesPerNick = 360.0f / totalNicks;	
	private static final int centerDegree = 90; // the one in the top center (12 o'clock)
	private static final int minDegrees = 0;
	private static final int maxDegrees = 180;
	...
	public gauge_speed(Context context) {
		super(context);
		init();
	}

	public gauge_speed(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public gauge_speed(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initDrawingTools() {
		...
		scalePaint.setStrokeWidth(0.0f);
		scalePaint.setAntiAlias(true);
		
		scalePaint.setTextSize(0.065f);
		...
		handPath.lineTo(0.5f - 0.003f, 0.5f - 0.32f);
		handPath.lineTo(0.5f + 0.003f, 0.5f - 0.32f);
		handPath.lineTo(0.5f + 0.020f, 0.5f);
		handPath.lineTo(0.5f, 0.5f);
		handPath.addCircle(0.5f, 0.5f, 0.050f, Path.Direction.CW);
